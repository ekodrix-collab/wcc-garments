      ...
      <AnimatePresence mode="wait">
        {success ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="relative flex w-full flex-col items-center justify-center text-black"
          >
            ...
            <div className="absolute bottom-1 left-0 right-0 h-[2px] overflow-hidden bg-black/10">
              <motion.div
          ...
          >
            {/* Left Fill */}
            <div className="flex h-full flex-1 items-center justify-center bg-gold px-6 text-black transition-colors group-hover:bg-gold-light">
              <span>{label}</span>
            </div>
            {/* Right Split Strip */}
            <div className="flex h-full w-16 items-center justify-center bg-gold-dark text-black transition-colors group-hover:bg-gold">
