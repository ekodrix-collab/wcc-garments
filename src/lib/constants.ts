...
export const DIVISIONS = [
  ...
  },
  {
    ...
    keywords: ['hotel linen supplier UAE', 'hospitality uniform manufacturer Dubai', 'hotel bed linen wholesale', 'chef uniform bulk order UAE', 'restaurant staff uniform Dubai', 'hotel towel supplier', 'hospitality textile manufacturer', 'spa linen wholesale UAE', 'resort uniform supplier', 'bulk hotel amenities Dubai'],
    ...
    categories: [
      { id: 'HOS-CAT-01', name: 'Bed Linen Sets', slug: 'bed-linen-sets', status: 'active' as const, displayOrder: 1, subCategories: [] },
      { id: 'HOS-CAT-02', name: 'Chef Uniforms', slug: 'chef-uniforms', status: 'active' as const, displayOrder: 2, subCategories: [] },
      { id: 'HOS-CAT-03', name: 'Spa & Bath Towels', slug: 'spa-bath-towels', status: 'active' as const, displayOrder: 3, subCategories: [] },
      { id: 'HOS-CAT-04', name: 'Restaurant Staff Wear', slug: 'restaurant-wear', status: 'active' as const, displayOrder: 4, subCategories: [] },
      { id: 'HOS-CAT-05', name: 'Pool & Beach Towels', slug: 'pool-beach-towels', status: 'coming-soon' as const, displayOrder: 5, subCategories: [] },
      { id: 'HOS-CAT-06', name: 'Bathrobes & Slippers', slug: 'bathrobes-slippers', status: 'coming-soon' as const, displayOrder: 6, subCategories: [] },
    ],
  },
  {
    name: 'Home',
  ...
  },
  {
    ...
    keywords: ['household products wholesale UAE', 'microfiber cloth manufacturer Dubai', 'cleaning supplies bulk UAE', 'bar mop wholesale supplier', 'industrial cleaning cloth Dubai', 'commercial cleaning products UAE', 'terry cloth bulk order', 'janitorial supplies wholesale Dubai', 'B2B household supplier UAE', 'cleaning textile manufacturer Middle East'],
    ...
    categories: [
      {
        id: 'HH-CAT-01', name: 'Kitchen', slug: 'kitchen', status: 'active' as const, displayOrder: 1,
        subCategories: [
          { id: 'HH-SUB-01', name: 'Cutlery', slug: 'cutlery', status: 'active' as const, displayOrder: 1 },
          { id: 'HH-SUB-02', name: 'Cookware', slug: 'cookware', status: 'active' as const, displayOrder: 2 },
          { id: 'HH-SUB-03', name: 'Utility', slug: 'utility', status: 'active' as const, displayOrder: 3 },
          { id: 'HH-SUB-04', name: 'Kitchen Essentials', slug: 'kitchen-essentials', status: 'active' as const, displayOrder: 4 },
          { id: 'HH-SUB-05', name: 'Dinnerware', slug: 'dinnerware', status: 'coming-soon' as const, displayOrder: 5 },
          { id: 'HH-SUB-06', name: 'Barware', slug: 'barware', status: 'coming-soon' as const, displayOrder: 6 },
          { id: 'HH-SUB-07', name: 'Kitchen Utensils', slug: 'kitchen-utensils', status: 'coming-soon' as const, displayOrder: 7 },
        ],
      },
      { id: 'HH-CAT-02', name: 'Microfiber & Cleaning', slug: 'microfiber-cleaning', status: 'active' as const, displayOrder: 2, subCategories: [] },
      { id: 'HH-CAT-03', name: 'Bulk Liquids & Sanitizers', slug: 'bulk-liquids-sanitizers', status: 'active' as const, displayOrder: 3, subCategories: [] },
      { id: 'HH-CAT-04', name: 'Institutional Linens', slug: 'institutional-linens', status: 'active' as const, displayOrder: 4, subCategories: [] },
      { id: 'HH-CAT-05', name: 'OEM Custom Essentials', slug: 'oem-custom-essentials', status: 'active' as const, displayOrder: 5, subCategories: [] },
      { id: 'HH-CAT-06', name: 'Table Top', slug: 'table-top', status: 'coming-soon' as const, displayOrder: 6, subCategories: [] },
      { id: 'HH-CAT-07', name: 'Bathroom Accessories', slug: 'bathroom-accessories', status: 'coming-soon' as const, displayOrder: 7, subCategories: [] },
      { id: 'HH-CAT-08', name: 'Horeca Products', slug: 'horeca-products', status: 'coming-soon' as const, displayOrder: 8, subCategories: [] },
      { id: 'HH-CAT-09', name: 'Seasonal Gifting', slug: 'seasonal-gifting', status: 'coming-soon' as const, displayOrder: 9, subCategories: [] },
    ],
  },
]
